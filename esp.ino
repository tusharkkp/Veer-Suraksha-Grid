...
// ─────────────────────────────────────────────────────────────────
#define WIFI_SSID        "ADD_YOUR_WIFI_SSID"
#define WIFI_PASSWORD    "ADD_YOUR_WIFI_PASSWORD"

// Firebase Realtime Database URL  (Firebase Console → Realtime Database → Data → URL)
#define FIREBASE_URL     "YOUR_FIREBASE_DB_URL" 

// Firebase Database Secret  (Firebase Console → Project Settings → Service Accounts → Database secrets)
#define FIREBASE_SECRET  "YOUR_FIREBASE_DB_SECRET"
...
//  THRESHOLDS
// ─────────────────────────────────────────────────────────────────
const int   MQ2_WARN             = 1500;   // H2S  ADC
const int   MQ2_DANGER           = 2500;
const int   MQ4_WARN             = 1200;   // CH4  ADC
const int   MQ4_DANGER           = 2200;
const int   MQ7_WARN             = 1000;   // CO   ADC
const int   MQ7_DANGER           = 2000;
const float TEMP_WARN            = 38.0f;
